...
image:
  feature: course/Clang/teachingCalendar.png
  teaser: course/Clang/teachingCalendar28.png
  credit: javascript
  creditlink: ""
---
...
![A瓶红酒与B瓶白酒互换](../assets/img/course/Clang/NSDiagram-1.png)
2. 框变矩形框
   1. 圆角矩形框可去除
   2. 矩形框继续保持矩形框
   3. 菱形框视条件变身
...
![三个整数从小到大排序](../assets/img/course/Clang/NSDiagram-2.png)
3. 空框补空白
   1. 菱形框变身后的左右两个三角形（Y, N），可能接下去没有处理框，需用空白框补齐
   2. 拐弯矩形的弯，要一直拐到循环结构内的所有操作命令处理完，可延伸

![求两个整数的最大公约数](../assets/img/course/Clang/NSDiagram-3.png)
...
![作业HW4.2](../assets/img/course/Clang/HW4.2.png)
